...
system("rm -r /home/au/code/SCRABBLE/A_matrix_test")
dir.create("/home/au/code/SCRABBLE/A_matrix_test/")
setwd("/home/au/code/SCRABBLE/A_matrix_test/")
...
for(dropout_index in c(1:3) ){
  ...
  for(seed_value in c(1:3)){
    dir.create("simulation_data")
    generate_save_data(dropout_index, seed_value,nGenes = 800, nbulk = 10, ncellsperbulk = 100)
...
for(dropout_index in c(1:3) ){
  ...
  for(seed_value in c(1:3)){
    run_scrabble_m(dropout_index, seed_value)
