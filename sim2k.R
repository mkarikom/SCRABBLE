...
system("rm -r /home/au/code/SCRABBLE/sim2k")
dir.create("/home/au/code/SCRABBLE/sim2k/")
setwd("/home/au/code/SCRABBLE/sim2k/")
...
tempcores = 3 # so the bulk data gen won't run out of ram
